            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    textfield(hintText: 'Nissan Sunny 2020'),
                    textfield(hintText: 'For sale'),
                    textfield(hintText: 'Egypt, Cairo, Masr el jadidah'),
                    textfield(hintText: '01125118300'),
                  ],
                ),
              )
            ],
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: Colors.white,
                    image:
                        DecorationImage(image: AssetImage('images/car.png'))),
              )
            ],
          ),
          Padding(
